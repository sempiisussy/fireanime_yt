...
export async function generateMetadata() {
  return {
    title: `Best Animes of the Last 24 Hours - Ani.cx`,
    description: `Browse the best animes of the last 24 hours.`,
  }
}

export default async function Best24hPage(props: {
  ...
  try {
    ...
    const response = await getBestLast24h(currentPage)
  ...
  return (
    <div className="w-full lg:pl-60">
      <div className="container py-6">
        <h1 className="text-2xl font-bold mb-6">Best Animes of the Last 24 Hours</h1>
        ...
        <AnimePagination currentPage={currentPage} totalPages={totalPages} pathPrefix="/best-24h" />
      </div>
    </div>
  )
}
